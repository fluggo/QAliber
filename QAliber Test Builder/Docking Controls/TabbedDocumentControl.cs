...
namespace Darwen.Windows.Forms.Controls.TabbedDocuments
{
	public partial class TabbedDocumentControl : UserControl
	{
		...
		public event DocumentHandler BeforeDocumentRemovedByUser;
		...
		{
			OnBeforeDocumentRemovedByUser(control);
		...
		protected virtual void OnBeforeDocumentRemovedByUser(Control control)
		{
			if (BeforeDocumentRemovedByUser != null)
			{
				BeforeDocumentRemovedByUser(this, control);
			}
		}
