...
namespace QAliber.VS2005.Plugin
{
	partial class ImageViewer
	{
		...
		private void InitializeComponent()
		{
			...
			// saveFileDialog
			// 
			this.saveFileDialog.Filter = "Bitmap Files|*.bmp|Jpeg files|*.jpg|All Files|*.*";
			...
			this.linkCreatePartialResource.Size = new System.Drawing.Size(159, 13);
			this.linkCreatePartialResource.TabIndex = 1;
			this.linkCreatePartialResource.TabStop = true;
			this.linkCreatePartialResource.Text = "Create File from Image Selection";
			...
			this.linkCreateResourceEntire.Size = new System.Drawing.Size(142, 13);
			this.linkCreateResourceEntire.TabIndex = 2;
			this.linkCreateResourceEntire.TabStop = true;
			this.linkCreateResourceEntire.Text = "Create File from Entire Image";
